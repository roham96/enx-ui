...
cd
````
2. سپس آخرین بسته فشرده را از https://github.com/roham96/enx-ui/releases/latest دانلود کنید، به طور معمول معماری «amd64» را انتخاب کنید.
...
**اگر یک نصب جدیدی باشد، این توابع، به خصوص محدود کردن IP، بی عیب و نقص کار خواهد کرد. اما اگر نسخه شما یک ارتقا باشد، ممکن است آن ها کار نکنند در حالی که وضعیت XRAY: اجرا نمی شود، باشد. در چنین مواردی لطفاً [اینجا](https://github.com/roham96/enx-ui/discussions/27) مراجعه کنید.
